...
import com.microchaos.backend.core.ExperimentRepository;
import com.microchaos.backend.core.ExperimentRunRepository;
import com.microchaos.backend.core.ExperimentService;
import com.microchaos.backend.core.InMemoryStore;
import com.microchaos.backend.core.MetricSnapshotRepository;
import com.microchaos.backend.core.MonitoringService;
import com.microchaos.backend.core.ServiceControlService;
import com.microchaos.backend.core.ServiceDependencyRepository;
import com.microchaos.backend.core.ServiceRegistryService;
import com.microchaos.backend.core.TargetServiceRepository;
...
public class MicroChaosBackendApplication {
    public static void main(String[] args) throws Exception {
        ...
        TargetServiceRepository targetServiceRepository = new TargetServiceRepository();
        ServiceDependencyRepository serviceDependencyRepository = new ServiceDependencyRepository();
        ExperimentRepository experimentRepository = new ExperimentRepository();
        ExperimentRunRepository experimentRunRepository = new ExperimentRunRepository();
        MetricSnapshotRepository metricSnapshotRepository = new MetricSnapshotRepository();
        ServiceRegistryService serviceRegistryService = new ServiceRegistryService(targetServiceRepository);
        ServiceControlService serviceControlService = new ServiceControlService(serviceRegistryService);
        TopologyService topologyService = new TopologyService(serviceDependencyRepository, serviceRegistryService);
        ...
        MonitoringService monitoringService = new MonitoringService(store, serviceRegistryService);
        AnalyticsService analyticsService = new AnalyticsService(serviceRegistryService, experimentService, monitoringService);
