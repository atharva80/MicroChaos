...
public class ExperimentService {
    ...
    public Experiment create(Map<String, String> params) {
        ...
        return experimentRepository.create(experiment);
    }
    ...
    public Experiment getExperiment(long id) {
        return experimentRepository.findById(id).orElseThrow(() -> new IllegalArgumentException("Experiment not found: " + id));
    }
    ...
    public Map<String, Object> runExperiment(long experimentId) {
        ...
        experimentRepository.updateStatus(experiment.getId(), experiment.getStatus());
        ExperimentRun run = runRepository.create(experimentId);
        ...
        metricSnapshotRepository.saveAll(metrics);
    ...
    public List<MetricSnapshot> metrics(long runId) {
        return metricSnapshotRepository.findByRunId(runId);
    }

    private ExperimentRun latestRunForExperiment(long experimentId) {
        return runRepository.findLatestByExperimentId(experimentId).orElse(null);
    }
