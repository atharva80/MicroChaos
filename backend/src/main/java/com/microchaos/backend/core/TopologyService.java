...
public class TopologyService {
    ...
    public TopologyService(ServiceDependencyRepository dependencyRepository, ServiceRegistryService serviceRegistry) {
    ...
    public List<Map<String, Object>> upstreamOf(long serviceId) {
        ...
        while (!queue.isEmpty()) {
            ...
            for (ServiceDependency dependency : listDependencies()) {
    ...
    public void seedDemoDependencies() {
        if (!dependencyRepository.isEmpty()) {
            return;
        }
